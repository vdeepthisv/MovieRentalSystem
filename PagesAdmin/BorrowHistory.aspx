<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/Admin.Master" AutoEventWireup="true" CodeBehind="BorrowHistory.aspx.cs" Inherits="delete2.BorrowHistory" %>
    ...
    <div id='divsearch'>
        ...
        <table class="style1">
            ...
            <tr>
                ...
                <td class="style4">
                    <asp:Button ID="btnNotReturned" runat="server" Text="Not Returned" 
                        style="margin-left: 23px" Width="96px" onclick="btnNotReturned_Click" 
                        Height="32px"/>
                </td>
            </tr>
        </table> 
